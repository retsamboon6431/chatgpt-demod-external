function main () {
    console.log("Initializing DeMod...");
    ...
    function updateDeModState() {
        console.log("Updating DeMod state:", is_on);
        if (is_on) {
    ...
    function updateDeModMessageState(mod_result) {
        console.log("Updating DeMod message state:", mod_result);
        switch (mod_result) {
    ...
    function clearFlagging(text) {
        console.log("Clearing flagging in text");
    ...
    class ChatResponse {
        ...
        async process(is_blocked) {
            console.log("Processing chat response:", this.chunk);
        ...
        replace(latest) {
            console.log("Replacing latest message:", latest);
            if (latest !== null) {
                this.payload.message = latest;
    ...
    class ChatEvent {
        ...
        async process(is_blocked) {
            console.log("Processing chat event:", this.response_data);
        ...
        replace(latest) {
            console.log("Replacing latest message in event:", latest);
